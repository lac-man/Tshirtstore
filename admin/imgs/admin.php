...
<a href="?action=modifyanddelete">Modifier / Supprimer </a><br/><br/>
...
if(!empty($imge_tmp)){
    ...
    if(in_array(strtolower($image_ext),array('png','jpg','jpeg'))===false){
        ...
        }else if($image_size['nime']=='image/png')
     ...
     if($image_src!==false){
         ...
         if($image_size[0]==$image_width){
            ...
            imagecopyresampled($image_finale,$image_src,0,0,0,0,$new_widht[0],$new_height[1],$image_size[1]);
